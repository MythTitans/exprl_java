...
public class ExpressionTest {
    ...
    public void literal_test() throws EvaluationException {
        ...
        Assert.assertEquals(-1, literal(-1).evaluateAsInteger(context));
        Assert.assertEquals(1, literal(1).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(-1, literal(-1).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(1, literal(1.0).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(-1, literal(-1.0).evaluateAsDecimal(context), 0.000001);
        ...
        Assert.assertEquals("1.0", literal(1.0).getExpressionName());
    ...
    public void add_test() throws Expression.EvaluationException {
        ...
        Assert.assertEquals(3, add(literal(1), literal(2)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(-1, add(literal(1), literal(-2)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(6, add(literal(1), literal(2), literal(3)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(0, add(literal(1), literal(2), literal(-3)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(-4, add(literal(1), literal(-2), literal(-3)).evaluateAsDecimal(context), 0.000001);
    ...
    public void sub_test() throws Expression.EvaluationException {
        ...
        Assert.assertEquals(-1, sub(literal(1), literal(2)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(3, sub(literal(1), literal(-2)).evaluateAsDecimal(context), 0.000001);
    ...
    public void mul_test() throws Expression.EvaluationException {
        ...
        Assert.assertEquals(6, mul(literal(2), literal(3)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(-6, mul(literal(2), literal(-3)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(24, mul(literal(2), literal(3), literal(4)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(-24, mul(literal(2), literal(3), literal(-4)).evaluateAsDecimal(context), 0.000001);
    ...
    public void div_test() throws Expression.EvaluationException {
        ...
        Assert.assertEquals(3, div(literal(6), literal(2)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(-3, div(literal(6), literal(-2)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(1.5, div(literal(6), literal(4)).evaluateAsDecimal(context), 0.000001);
    ...
    public void mod_test() throws Expression.EvaluationException {
        ...
        Assert.assertEquals(0, mod(literal(6), literal(2)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(1, mod(literal(5), literal(2)).evaluateAsDecimal(context), 0.000001);
    ...
    public void len_test() throws Expression.EvaluationException {
        ...
        Assert.assertEquals(6, len(literal("abcdef")).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(5, len(literal("abcde")).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(0, len(literal("")).evaluateAsDecimal(context), 0.000001);
    ...
    public void min_test() throws Expression.EvaluationException {
        ...
        Assert.assertEquals(0, min(literal(0), literal(1)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(-1, min(literal(0), literal(-1)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(-5, min(literal(0), literal(-1), literal(-5)).evaluateAsDecimal(context), 0.000001);
    ...
    public void max_test() throws Expression.EvaluationException {
        ...
        Assert.assertEquals(1, max(literal(0), literal(1)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(0, max(literal(0), literal(-1)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(5, max(literal(0), literal(-1), literal(5)).evaluateAsDecimal(context), 0.000001);
    ...
    public void var_test() throws EvaluationException {
        ...
        Assert.assertEquals(1.5, var(literal("variable-decimal")).evaluateAsDecimal(context), 0.000001);
        ...
        Assert.assertEquals(4.5, var(literal("variable-decimal")).evaluateAsDecimal(context), 0.000001);
    ...
    public void cond_test() throws EvaluationException {
        ...
        Assert.assertEquals(1.5, cond(literal(true), literal(1.5), literal(2.5)).evaluateAsDecimal(context), 0.000001);
        Assert.assertEquals(2.5, cond(literal(false), literal(1.5), literal(2.5)).evaluateAsDecimal(context), 0.000001);
